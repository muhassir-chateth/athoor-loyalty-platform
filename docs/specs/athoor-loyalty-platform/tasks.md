...
- [ ] 34. Wire the dashboard's referral code to `/v1/referral`
...
- [ ] 35. Refresh the metafield cache on referral credits
...
- Tasks 34 and 35 came out of the task 27 audit and are storefront **correctness** defects, not polish: members are shown a fabricated referral code, and one member's fallback balance understates by 5×. Neither is blocked on the storefront prerequisites, so both can proceed now.
...
```json
{
  "waves": [
    ...
    { "id": 24, "tasks": ["21.2"] },
    { "id": 25, "tasks": ["23", "24", "25", "27", "29", "30", "31", "32", "33", "34", "35"] },
    { "id": 26, "tasks": ["26", "28"] }
  ]
}
```

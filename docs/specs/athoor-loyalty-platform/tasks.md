...
- [x] 35. Refresh the metafield cache on referral credits
  ...
  - **Not verified live** — the fix is not yet deployed, and driving a claim against the deployed build would exercise the old path and prove nothing. Verify after deploy.

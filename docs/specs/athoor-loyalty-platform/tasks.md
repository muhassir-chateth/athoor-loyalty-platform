...
- Task 33 (migration operator tooling) came out of the task 26 rehearsal and unblocked its sign-off. Remaining open Phase 5 work: **27** (dashboard/Lighthouse/accessibility, blocked on storefront prerequisites, and also the source of the outstanding M2 evidence for task 26), **30** (VIP benefits), **31** (profile preference writes), **32** (config-driven rules). Tasks 34, 35 and 36 are complete.
...
```json
{
  "waves": [
    ...
    { "id": 24, "tasks": ["21.2"] },
    { "id": 25, "tasks": ["23", "24", "25", "27", "29", "30", "31", "32", "33", "34", "35", "36"] },
    { "id": 26, "tasks": ["26", "28"] }
  ]
}
```
